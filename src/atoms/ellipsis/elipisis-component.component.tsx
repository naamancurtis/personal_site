...
const SvgEllipsis = ({ hideComponent }: EllipsisProps) => {
  const theme = useContext(ThemeContext);

  const self = useRef<SVGSVGElement | null>(null);
  const leftCircle = useRef<SVGCircleElement | null>(null);
  const rightCircle = useRef<SVGCircleElement | null>(null);
  ...
  const [hiddenTimeline, setHiddenTimeline] = useState<TimelineLite>(
    new TimelineLite()
  );
